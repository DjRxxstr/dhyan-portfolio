        ...
        <div className="flex flex-col gap-10 items-center">
            ...
            <motion.div variants={fadeIn("", "", 0.1, 1)}>
                <a 
                  ...
                  target="_blank">
                    <button
                    className='cursor-pointer hover:bg-white hover:text-black transition-all duration-300 rounded-4xl border-1 border-white px-8 py-4 flex flex-row items-center gap-4 w-full'>
                    Visit My Resume
                    <svg
